...
class ExpencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create expence" do
    assert_difference("Expence.count") do
      post expences_url, params: { expence: { amount: @expence.amount, author_id: @expence.author_id, name: @expence.name } }
    end
  ...
  test "should update expence" do
    patch expence_url(@expence), params: { expence: { amount: @expence.amount, author_id: @expence.author_id, name: @expence.name } }
